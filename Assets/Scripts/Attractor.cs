...
public class Attractor : MonoBehaviour
{
    ...
    public void Attract(Transform body)
    {
        ...
        void Start()
        {
            ...
            Attractors.Add(GameObject.FindGameObjectWithTag("Earth").GetComponent<Attractor>());
        ...
        void FixedUpdate()
        {
        if (m_Rigidbody != null && m_Transform != null && !this.gameObject.tag.Equals("Earth"))
            {
                ...
                //Attractors[0].Attract(m_Transform);
                //attractor.Attract(m_Transform);
        }
        }
